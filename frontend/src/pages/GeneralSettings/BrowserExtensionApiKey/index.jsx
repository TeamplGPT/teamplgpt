          ...
          <div className="w-full flex flex-col gap-y-1 pb-6 border-white/10 border-b-2">
            <div className="items-center flex gap-x-4">
              <p className="text-lg leading-6 font-bold text-theme-text-primary">
                {t("browser_extension.title")}
              </p>
            </div>
            <p className="text-xs leading-[18px] font-base text-theme-text-secondary mt-2">
              {t("browser_extension.description")}
            </p>
          </div>
                ...
                <thead className="text-theme-text-secondary text-xs leading-[18px] font-bold uppercase border-white/10 border-b">
                  <tr>
                    <th scope="col" className="px-6 py-2 rounded-tl-lg">
                      {t("browser_extension.table.connection-string")}
                    </th>
                    {isMultiUser && (
                      <th scope="col" className="px-6 py-2">
                        {t("browser_extension.table.created-by")}
                      </th>
                    )}
                    <th scope="col" className="px-6 py-2">
                      {t("browser_extension.table.created-at")}
                    </th>
                    <th scope="col" className="px-6 py-2 rounded-tr-lg">
                      {t("browser_extension.table.actions")}
                    </th>
                  </tr>
                </thead>
                <tbody>
