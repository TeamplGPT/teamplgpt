...
const ROLE_HINT = {
  default: [
    "users.role.descriptions.default1",
    "users.role.descriptions.default2",
  ],
  manager: [
    "users.role.descriptions.manager1",
    "users.role.descriptions.manager2",
    "users.role.descriptions.manager3",
  ],
  admin: ["users.role.descriptions.admin1", "users.role.descriptions.admin2"],
};
      ...
      <div className="flex flex-col gap-y-1">
        <div className="flex items-center gap-x-2">
          <h2 className="text-base leading-6 font-bold text-white">
            {t("users.add.limit-messages-per-day")}
          </h2>
        ...
        <p className="text-xs leading-[18px] font-base text-white/60">
          {t("users.add.limit-messages-per-day-description")}
        </p>
      </div>
      {enabled && (
        <div className="mt-4">
          <label className="text-white text-sm font-semibold block mb-4">
            {t("users.add.messages-limit-per-day")}
          </label>
