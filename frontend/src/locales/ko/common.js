...
const TRANSLATIONS = {
  ...
  general: {
    ...
    shared: {
      title: "공용 워크스페이스",
      toggle: "이 워크스페이스를 공용으로 설정",
      warning: "이 워크스페이스의 문서는 모든 워크스페이스에서 검색됩니다. admin만 문서를 관리할 수 있습니다.",
      alreadyExists: "이미 공용 워크스페이스가 존재합니다.",
      deleteWarning: "이 워크스페이스의 임베딩은 모든 워크스페이스에서 사용 중입니다. 삭제하시겠습니까?",
      convertOnWarning: "이 워크스페이스의 문서가 모든 워크스페이스에서 검색됩니다. 기존 비admin 멤버가 제거됩니다. 계속하시겠습니까?",
      convertOffWarning: "다른 워크스페이스에서 더 이상 공용 데이터를 사용할 수 없습니다. 계속하시겠습니까?",
      sourcePrefix: "공용",
      badge: "공용 워크스페이스",
    },
  },
  ...
  "vector-workspace": {
    ...
    searchMode: {
      ...
      default: {
        title: "기본",
        description:
          "가장 빠른 성능을 제공하지만, 가장 관련성 높은 결과를 반환하지 못해 모델 환각이 발생할 수 있습니다.",
      },
      rerank: {
        title: "정확도 최적화",
        description:
          "LLM 응답 생성이 더 오래 걸릴 수 있지만, 응답이 더 정확하고 관련성이 높습니다.",
      },
      hybrid: {
        title: "하이브리드 (벡터 + 키워드)",
        description:
          "시맨틱 벡터 검색과 키워드 매칭(BM25)을 상호 순위 융합(RRF)으로 결합합니다. 한국어 텍스트와 정확한 용어 매칭에 최적화되어 있습니다.",
      },
    },
  },
  agent: {
